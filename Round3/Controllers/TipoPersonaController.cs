...
namespace Round3.Controllers
{
    public class TipoPersonaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idTipoP,nombreTipoP")] TipoPersona tipoPersona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idTipoP,nombreTipoP")] TipoPersona tipoPersona)
        {
            if (ModelState.IsValid)
            {
