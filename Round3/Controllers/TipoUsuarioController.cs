...
namespace Round3.Controllers
{
    public class TipoUsuarioController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idTipoU,nombreTipoU")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idTipoU,nombreTipoU")] TipoUsuario tipoUsuario)
        {
            if (ModelState.IsValid)
            {
